            ...
            <div class="flex flex-col gap-2 mt-2">
              ...
              <div class="flex gap-2 w-full items-center">
                <?php if (!$is_pending): ?>
                  ...
                  <a href="?page=preview_resume&id=<?= $r['id'] ?>&print=1" target="_blank" class="flex-1 flex items-center justify-center gap-1 border border-outline-variant/60 text-on-surface-variant hover:text-primary py-2 rounded-xl font-label-md text-center hover:bg-surface-variant transition-all active:scale-95 text-xs font-semibold bg-surface-variant/30">
